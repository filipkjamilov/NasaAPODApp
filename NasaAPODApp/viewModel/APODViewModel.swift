...
class APODViewModel: ObservableObject {
    ...
    func fetchData(startDate: Date = Date.now, endDate: Date = Date.now) {
        ...
        let url = "https://api.nasa.gov/planetary/apod?api_key=mj7IKILdJygMqg3HYTVvQJl0sO870jpCLA6Yv7ch&start_date=\(Date.convertDateToString(date: startDate))&end_date=\(Date.convertDateToString(date: endDate))"
